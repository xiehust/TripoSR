...
if [[ $region =~ ^cn ]]; then
    BASE_IMAGE="727897471807.dkr.ecr.${region}.amazonaws.${suffix}/pytorch-training:2.5.1-gpu-py311"
    PIP_INDEX="https://mirrors.aliyun.com/pypi/simple"
else
    BASE_IMAGE="763104351884.dkr.ecr.${region}.amazonaws.${suffix}/pytorch-training:2.5.1-gpu-py311"
